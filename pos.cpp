...
int main (){
  char member;
  int i, n;
  double diskon, harga_barang[10],jumlah_barang[10],grandtotal,subtotal,total[10];
  string nama_barang[10];
  cout<<"=================================\n";
  cout<<"========== POS SEDERHANA ========\n";
  cout<<"=================================\n\n";
  cout<<"Apakah Sebelumnya anda sudah menjadi member kami 'Y'/'N' ? \n";
  cin>>member; 
  ...
  subtotal = 0;
  for(i=1;i<=n;i++){
    total[i] = jumlah_barang[i] * harga_barang[i];
    subtotal += total[i];
    cout<< nama_barang[i]<<"\n";
    cout<< jumlah_barang[i]<<" PCS  x  "<<harga_barang[i]<<"  =  "<<total[i]<<"  \n";
    cout<<"-------------------------------------\n";
  }
